...
class CategoriesModal2 extends StatelessWidget {
  final void Function(String) onCategorySelected;
  const CategoriesModal2({super.key,required this.onCategorySelected});
      ...
      padding: EdgeInsets.all(16.0),
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return GestureDetector(
            onTap: () {
               final myCategorie = category.title;
                    onCategorySelected(myCategorie);
                    Navigator.pop(context, myCategorie);
            },
